...
import { AllFacultyReports } from "./AllFacultyReports";
...
export function EventReportManager() {
  ...
  const handleCreateReport = (e: React.FormEvent) => {
    ...
    // formData.append('thumbnail', newReport.thumbnailFile);
    // newReport.galleryFiles.forEach((file, index) => {
    //   formData.append(`gallery_${index}`, file);
    // });
    // formData.append('eventName', newReport.eventName);
    // formData.append('community', newReport.community);
    // formData.append('eventDate', newReport.eventDate);
    // formData.append('description', newReport.description);
    // formData.append('location', newReport.location);
    // formData.append('participants', newReport.participants);
    // formData.append('duration', newReport.duration);
    // formData.append('objectives', newReport.objectives);
    // formData.append('outcomes', newReport.outcomes);
    // 
  ...
  // If viewing a report, show blog viewer
  if (isViewOpen && selectedReport) {
    return (
      <EventReportBlogViewer
        ...
        onRespondToAdminReview={handleResponse}
